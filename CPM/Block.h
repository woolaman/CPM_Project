...
private: // private functions
	...
	// 线性插值函数
	double interp1Linear(const std::vector<double>& x, const std::vector<double>& y, double xq);

	// interp1 函数实现
	std::vector<double> interp1(const std::vector<double>& x, const std::vector<double>& y, const std::vector<double>& xq);
};